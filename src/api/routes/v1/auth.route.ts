...
router.get('/facebook/callback', passport.authenticate('facebook'), async (req: any, res: any) => {
  res.redirect('http://localhost:3000/social-verif/'+req.user.facebookAuth.accessToken)
});


router.get('/google/callback', passport.authenticate("google"), async (req: any, res: any) => {
